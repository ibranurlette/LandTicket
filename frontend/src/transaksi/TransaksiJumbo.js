         ...
         <Table responsive>
          ...
          <tbody key={index}>
            <tr>
              ...
              <td >{item?.train?.startStation}-{item?.train?.destination}</td>
              ...
              <td >{item.status}</td>
              <td>
                <div className="mr-2"><Modal_detail data={item}/></div>
                <div className="mr-2"><Modal_edit id="modal-login" data={item}/></div>
                <div className="mr-2"><Delete data={item} /></div>
              </td>
            </tr>
          </tbody>
          ))}
