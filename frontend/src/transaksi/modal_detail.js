      ...
      <main>
        ...
        >
          <Card id="card_jumbo_detail">
            <Row>
              <Col sm={5}>
                <font id="detail_invoice">
                  <strong>invoice</strong>
                </font>
                <br />
                <font id="detail_kereta">
              ...
              <Col sm={3}>
                <font>
                  <img alt="struk_detail" id="struk_detail" src={struk} />
                </font>
            ...
            <Form>
              <Form.Row>
                ...
                <Form.Group
                  ...
                  id="name_pemesan_detail"
                >
                  <p>
                    <strong>{data?.train?.user?.username}</strong>
                  </p>
                  <p>ibra nurlette</p>
                </Form.Group>
