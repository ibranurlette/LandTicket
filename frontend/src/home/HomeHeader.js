...
class Header extends Component {
  ...
  render() {
    ...
    return(
      ...
      <div id = "profile" >{data.name} &nbsp;&nbsp;&nbsp;<img alt="foto" src = {profile} id="foto"/></div>
      </Dropdown.Toggle>
      <Dropdown.Menu >
      <Link to= "/ticket" >
      <div> <TiTicket id="dropdown"/> ticket saya </div>
      </Link>
      <div onClick={handleLogout} id="dropdown_logout2"><IoMdLogOut id="dropdown_logout"/>logout</div>
      </Dropdown.Menu>
      </Dropdown>
      </Navbar.Text>
      </Navbar.Collapse>
